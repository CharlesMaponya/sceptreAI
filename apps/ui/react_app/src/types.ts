...
export interface DatasetVersion {
  ...
  schema_json?: { columns?: Array<{ name: string; dtype?: string }> };
  dataset_schema?: { columns?: Array<{ name: string; dtype?: string }> };
  created_at: string;
}
...
export interface TrainingEstimate {
  ...
  memory_request_mb: number; estimated_core_hours: number; can_launch: boolean;
